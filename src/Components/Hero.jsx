        ...
        <div className="h-[75%] w-full flex flex-col">
          ...
          <div className="Hero-heading w-full h-[60%] text-white font-semibold flex flex-col items-start justify-center lg:items-center">
            <div className="flex flex-col lg:flex-row lg:gap-4 items-start justify-center">
              <motion.h1 className="font-semibold text-7xl uppercase font-[myHeadingfont] md:text-[17vw] lg:text-[11vw]">
                Unleash
              </motion.h1>
              <motion.h1 className="font-semibold text-7xl uppercase font-[myHeadingfont] md:text-[17vw] lg:text-[11vw]">
                Your
            ...
            <div className="flex flex-col lg:flex-row lg:gap-4 items-start justify-center">
              ...
              <motion.h1 className="font-semibold text-7xl uppercase font-[myHeadingfont] text-[#e4ff1a] md:text-[17vw] lg:text-[11vw]">
                Athlete
              </motion.h1>
            </div>
          </div>
          ...
          {/* Subheading */}
          <motion.div className="Hero-sub-heading w-full h-[20%] text-white font-semibold flex flex-col items-start justify-center lg:items-center">
          ...
          <div className="Hero-calltoaction w-full h-[15%] text-white font-semibold flex items-center justify-around md:justify-start md:gap-5 lg:justify-center">
            <motion.div onClick={() => navigate('/contact')} className="cursor-pointer">
              <Button title="join now" />
            </motion.div>
            <motion.div onClick={() => navigate('/about')} className="cursor-pointer">
